...
with sync_playwright() as pw:
    ...
    print("\n== RESULTS ==")
    p.fill("#srchInput","ammonia"); p.wait_for_timeout(400)
    ...
    print("\n== LOCKED UNITS ==")
    p.fill("#srchInput","Pompe"); p.wait_for_timeout(450)
    ...
    print("\n== NAVIGATION ==")
    p.fill("#srchInput","anion gap"); p.wait_for_timeout(450)
    ...
    p.fill("#srchInput","begin with the trajectory"); p.wait_for_timeout(450)
