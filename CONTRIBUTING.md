...
3. **A primary source.** a BIMDG or international disease guideline, a current GeneReviews chapter, IAP–NNF guidance, a named national guideline, or a peer-reviewed paper. Please cite the specific recommendation or page, not the document as a whole.
...
Metabolic guidance changes often &mdash; GeneReviews chapters are revised continually, emergency protocols differ between centres, and India&rsquo;s rare-disease policy is amended every few months. If a guideline changes, open an issue titled:
